const pages = [
  ...
  {img:'assets/page5.png',title:'الصداقة أجمل',text:'عادا إلى البيت وجلسا قرب النافذة يشاهدان المطر. قال الدب: الصداقة مثل المطر، تجعل حياتنا أجمل.'}
];
...
function buildColorButtons(){
  ...
  $('#eraserBtn').onclick = () => brushColor = '#ffffff';
  $('#clearBtn').onclick = () => loadColorPage(colorIndex);
